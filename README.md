...
As of June 2024, the project transitioned into maintenance mode. While this implies that no further features or enhancements will be introduced, the software continues to be actively maintained with bugfixes and updates if needed.
